...
#define sizeof_NEWFONT                                                         \
  (sizeof_BYTE + sizeof_WORD + sizeof_BYTE * 3 + sizeof_BYTE * 5 +             \
   sizeof_DWORD + sizeof_BYTE * 12 + sizeof_WORD + sizeof_BYTE * 10)
...
#define sizeof_MVBFONT                                                         \
  (sizeof_WORD * 3 + sizeof_BYTE * 3 * 2 + sizeof_DWORD + sizeof_BYTE * 12 +   \
   sizeof_WORD + sizeof_BYTE * 12)
